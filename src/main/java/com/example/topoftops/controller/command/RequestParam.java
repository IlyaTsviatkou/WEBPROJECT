...
public class RequestParam {
    public static final String PARAM_NAME_TOP = "topid";
    public static final String PARAM_NAME_USER = "userid";
    public static final String PARAM_NAME_REPORT = "reportid";
    ...
    public static final String PARAM_NAME_ITEM = "itemid";
    ...
    public static final String PARAM_NAME_SEARCH_STRING = "searchString";
    public static final String PARAM_NAME_SEARCH_RATING = "rating";
